...
<script language="javascript">
	...
	function CheckAdv(obj)
	{
		...
		if(!CheckNull(obj.txtAdvLink, 'URL'))
			return false;
		if(!CheckNull(obj.txtAdvFile, 'File'))
			return false;
		return true;
	}
</script>
             				...
             				<TBODY>
              				<TR>
								<TD>
									...
									<TBODY>
									<TR>
										<TH>Thêm mới quảng cáo vào hệ thống</TH>
									</TR>
									</TBODY>
									</TABLE>
                  				</TD>	
...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TR>
								  		...
								  		<TD><INPUT type="text" style="WIDTH: 200px" name="txtAdvName"></TD>
									</TR>
									<TR>
									...
									<TR>
								  		...
								  		<TD>
								  			<input type="radio" name="radAdvStatus" value="0" checked id="hide">
								  			<label for="hide">Ẩn</label>&nbsp;&nbsp;&nbsp;&nbsp;
								  			<input type="radio" name="radAdvStatus" value="1" id="display">
								  			<label for="display">Hiện</label>
								  		</TD>
									</TR>
									<TR >
								  		<TH>URL :<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT type="text" style="WIDTH: 200px" name="txtAdvLink" value="http://"></TD>
									</TR>
									<TR>
