        			...
        			<TR>
          				<TD>
							...
							<TR>
								...
								<TD width="95%"><SPAN class=title>Quản trị đơn vị tính QTM-GROUP </SPAN></TD>
							</TR>
							</TBODY>
							</TABLE>
            				<TABLE class=content>
                				...
                				<TD>
									...
									<TR>
									  <TD vAlign=bottom align=right width="100%">
									  	<A title="Danh sách" href="?page=unit&do=list"><IMG class=icon src="images/list.gif"></A>&nbsp;&nbsp;&nbsp; 
...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TBODY>
									<TR>
								  		<TH>Tên đơn vị tính :<SPAN class=note>*</SPAN></TH>
