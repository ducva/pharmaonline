        			...
        			<TR>
          				<TD>
							...
							<TR>
								...
								<TD width="95%"><SPAN class=title>Quản trị trang dịch vụ QTM-GROUP </SPAN></TD>
							</TR>
							</TBODY>
							</TABLE>
            				<TABLE class=content>
                				...
                				<TD>
									...
									<TR>
									  <TD vAlign=bottom align=right width="100%">
									  	<A title="Danh sách" href="?page=news&do=list"></A>&nbsp;&nbsp;&nbsp; 
										<A title="Cập nhập dữ liệu" onclick=window.location.reload(); 
href="#"><IMG class=icon src="images/refresh.gif"></A> 
										<A title="Giúp đỡ" href="#" target=_blank><IMG class=icon src="images/help.gif"></A>									  </TD>
									</TR>
									</TBODY>
									</TABLE>
                  					<TABLE class=form>
									<TBODY>
									<TR>
								  		<TH valign="top">Chi tiết trang dịch vụ: </TH>
								  		<TD>&nbsp;</TD>
									</TR>
									<TR align="center">
								  		<TD colspan="2" align="center" style="padding-left:80px;">{DETAIL}</TD>
									</TR>
									</TBODY>
									</TABLE>
                  					<BR>
