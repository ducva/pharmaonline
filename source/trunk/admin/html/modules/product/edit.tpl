...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TR>
								  		...
								  		<TD><INPUT name="txtName" id="txtName" style="WIDTH: 660px" value="{NAME}"></TD>
									</TR>
									<TR>
								  		<TH>Mã sản phẩm:<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT name="txtCode" id="txtCode" style="WIDTH: 300px" value="{CODE}"></TD>
									</TR>
									<TR>
								  		<TH valign="top">Mô tả ngắn :<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><textarea name="txtDescription" cols="50" rows="5" id="txtInfo">{DESCRIPTION}</textarea></TD>
									</TR>
									<TR>
								  		<TH valign="top">Thông tin chi tiết :<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><textarea name="txtDetail" cols="50" rows="5" id="txtInfo">{DETAIL}</textarea></TD>
									</TR>
									<TR>
								  		...
								  		<TD>
											...
											<input type="hidden" name="hdnOldCategoryId" value="{CATEGORYID}" />									
										</TD>
									</TR>
									<TR>
									...
									<TR>
								  		...
								  		<TD valign="middle">
											<input name="txtPriceQTM" type="text" id="txtPriceQTM" value="{PRICEQTM}" />									  </TD>
									</TR>
									<TR>
								  		...
								  		<TD>
											<select name="cboCurrency">
												<option value="0"></option>
												<!-- BEGIN: CURRENCY -->
												<option value="{CURRENCY.VALUE}" {CURRENCY.SELECTED}>{CURRENCY.NAME}</option>
												<!-- END: CURRENCY -->
											</select>										</TD>
									</TR>
									<TR>
								  		...
								  		<TD>
											<select name="cboUnit">
												<option value="0"></option>
												<!-- BEGIN: UNIT -->
												<option value="{UNIT.VALUE}" {UNIT.SELECTED}>{UNIT.NAME}</option>
												<!-- END: UNIT -->
											</select>										</TD>
									</TR>
									<TR>
								  		...
								  		<TD>
											<select name="cboProvider">
												<option value="0"></option>
												<!-- BEGIN: PROVIDER -->
												<option value="{PROVIDER.VALUE}" {PROVIDER.SELECTED}>{PROVIDER.NAME}</option>
												<!-- END: PROVIDER -->
											</select>										</TD>
									</TR>
									<TR>
									...
									<TR>
									  ...
									  <TD>
									  		<input type="radio" name="radHotProduct" value="0" style="border: 0px;" {CHECKED_0}>Sản phẩm bình thường
				...
				<input type="radio" name="radHotProduct" value="2" style="border: 0px;" {CHECKED_2}>Sản phẩm tiêu biểu
									...
									<TR>
								  		<TH><input type="checkbox" onClick="javascript:MaxMin('NewImage')" name="chkNewImage" value="1" > Ảnh minh họa mới? :<SPAN class=note>&nbsp;&nbsp;</SPAN></TH>
								  		<TD>
											<div id="NewImage" style="display:none;">
												<INPUT type="file" style="WIDTH: 400px" name="txtImage">
											</div>		
										</TD>
									</TR>
									<TR>
								  		<TH>Chú thích ảnh:<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><input name="txtImageNote" id="txtImageNote" style="WIDTH: 660px" value="{IMAGENOTE}" /></TD>
									</TR>
