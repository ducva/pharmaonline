             				...
             				<TBODY>
              				<TR>
								<TD>
									...
									<TBODY>
									<TR>
										<TH>Thêm mới  quản trị viên vào hệ thống</TH>
									</TR>
									</TBODY>
									</TABLE>
                  				</TD>	
                				...
                				<TD>
									...
									<TR>
									  <TD vAlign=bottom align=right width="100%">
									  	<A title="Danh sách" href="?page=admin&do=list"><IMG class=icon src="images/list.gif"></A>&nbsp;&nbsp;&nbsp; 
...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TR>
								  		...
								  		<TD><INPUT style="WIDTH: 200px" name="txtUsername"></TD>
									</TR>
									<TR>
								  		<TH>Mật khẩu :<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT type="password" style="WIDTH: 200px" name="txtPassword"></TD>
									</TR>
									<TR>
								  		<TH>Xác nhận mật khẩu :<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT type="password" style="WIDTH: 200px" name="txtConfirmPassword"></TD>
									</TR>
									</TBODY>
									</TABLE>
                  					<BR>
