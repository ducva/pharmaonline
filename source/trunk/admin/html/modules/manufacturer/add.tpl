                				...
                				<TD>
									...
									<TR>
									  <TD vAlign=bottom align=right width="100%">
									  	<A title="Danh sách" href="?page=manufacturer&do=list"><IMG class=icon src="images/list.gif"></A>&nbsp;&nbsp;&nbsp; 
...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TBODY>
									<TR>
								  		<TH>Tên hãng sản xuất:<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT name="txtName" id="txtName" style="WIDTH: 660px"></TD>
									</TR>
									<TR>
								  		<TH>Địa chỉ :<SPAN class=note>&nbsp;&nbsp;</SPAN></TH>
								  		<TD><INPUT style="WIDTH: 660px" name="txtAddress"></TD>
									</TR>
									<TR>
									...
									<TR>
								  		...
								  		<TD><INPUT name="txtTelephone" type="text" id="txtTelephone" style="WIDTH: 200px"></TD>
									</TR>
									<TR>
								  		<TH>Mobile :<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><INPUT name="txtMobile" type="text" id="txtMobile" style="WIDTH: 200px"></TD>
									</TR>
									<TR>
								  		<TH>Fax :<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><INPUT name="txtFax" type="text" id="txtFax" style="WIDTH: 200px"></TD>
									</TR>
									<TR>
								  		<TH>Website :<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><INPUT name="txtWebsite" type="text" id="txtWebsite" style="WIDTH: 200px"></TD>
									</TR>
									<TR>
