             				...
             				<TBODY>
              				<TR>
								<TD>
									...
									<TBODY>
									<TR>
										<TH>Thêm qui định mới vào hệ thống</TH>
									</TR>
									</TBODY>
									</TABLE>
                  				</TD>	
                				...
                				<TD>
									...
									<TR>
									  <TD vAlign=bottom align=right width="100%">
									  	<A title="Danh sách" href="?page=rules&do=list"><IMG class=icon src="images/list.gif"></A>&nbsp;&nbsp;&nbsp; 
...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TBODY>
									<TR>
								  		<TH>Tên qui định:<SPAN class=note>*</SPAN></TH>
