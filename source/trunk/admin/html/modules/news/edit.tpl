...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TR>
								  		...
								  		<TD><INPUT name="txtTitle" id="txtTitle" style="WIDTH: 660px" value="{TITLE}"></TD>
									</TR>
									<TR>
								  		...
								  		<TD>
											<select name="cboNewsCategoryId">
												<!-- BEGIN: NEWSCATEGORY -->
												<option id="level1" value="{NEWSCATEGORY.ID}" {NEWSCATEGORY.SELECTED}>{NEWSCATEGORY.NAME}</option>
													<!-- BEGIN: CHILDNEWSCATEGORY -->
													<option value="{CHILDNEWSCATEGORY.ID}" {CHILDNEWSCATEGORY.SELECTED}> ---- {CHILDNEWSCATEGORY.NAME}</option>	
									...
									<TR>
								  		...
								  		<TD><INPUT name="chkHotNews" type="checkbox" value="1" {HOTNEWSCHECKED}></TD>
									</TR>
									</TBODY>
									</TABLE>
                  					<BR>
