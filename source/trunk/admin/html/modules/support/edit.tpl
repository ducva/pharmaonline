        			...
        			<TR>
          				<TD>
							...
							<TR>
								...
								<TD width="95%"><SPAN class=title>Hỗ trợ viên </SPAN></TD>
							</TR>
							</TBODY>
							</TABLE>
            				<TABLE class=content>
                				...
                				<TD>
									...
									<TR>
									  <TD vAlign=bottom align=right width="100%">
									  	<A title="Danh sách" href="?page=support&do=list"><IMG class=icon src="images/list.gif"></A>&nbsp;&nbsp;&nbsp; 
...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TR>
								  		...
								  		<TD><INPUT style="WIDTH: 200px" name="txtName" value="{NAME}"></TD>
									</TR>
									<TR>
								  		<TH>Chức vụ:<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT type="text" style="WIDTH: 200px" name="txtTitle" value="{TITLE}"></TD>
									</TR>
									<TR>
								  		<TH>Skype:<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT type="text" style="WIDTH: 200px" name="txtSkype" value="{SKYPE}"></TD>
									</TR>
									<TR>
								  		<TH>Yahoo:<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT type="text" style="WIDTH: 200px" name="txtYahoo" value="{YAHOO}"></TD>
									</TR>
									<TR>
								  		<TH>Mobile:<SPAN class=note>*</SPAN></TH>
								  		<TD><INPUT type="text" style="WIDTH: 200px" name="txtMobile" value="{MOBILE}"></TD>
									</TR>
									<TR>
								  		<TH>Trạng Thái:<SPAN class=note>*</SPAN></TH>
								  		<TD>
								  			<input type="checkbox" {STATUS} name="chkStatus" value="1"/>
										</TD>
									</TR>
									</TBODY>
									</TABLE>
