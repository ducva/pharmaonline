...
href="#"><IMG class=icon src="images/refresh.gif"></A> 
									...
									<TR>
								  		...
								  		<TD><INPUT name="txtName" style="WIDTH: 660px" value="{NAME}"></TD>
									</TR>
									<TR>
								  		...
								  		<TD>
											<select name="cboPropertyId">
												...
												<!-- BEGIN: PROPERTY -->
												<option value="{PROPERTY.ID}" {PROPERTY.SELECTED}>{PROPERTY.NAME}</option>
									...
									<TR>
								  		...
								  		<TD><textarea name="txtDetail" cols="40" rows="3" id="txtDetail">{DETAIL}</textarea></TD>
									</TR>
									<TR>
								  		<TH>Đơn vị:<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><INPUT name="txtUnit" style="WIDTH: 200px" value="{UNIT}"></TD>
									</TR>
									<TR>
								  		<TH>Các giá trị:<SPAN class=note>&nbsp;</SPAN></TH>
								  		<TD><INPUT name="txtValue" id="txtValue" style="WIDTH: 400px" value="{VALUE}"></TD>
									</TR>
									</TBODY>
									</TABLE>
                  					<BR>
